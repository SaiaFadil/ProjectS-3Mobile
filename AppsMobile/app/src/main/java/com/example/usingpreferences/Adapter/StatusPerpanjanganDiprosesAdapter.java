...
public class StatusPerpanjanganDiprosesAdapter extends RecyclerView.Adapter<StatusPerpanjanganDiprosesAdapter.ViewHolder> {
    ...
    public StatusPerpanjanganDiprosesAdapter(List<ModelStatusPerpanjanganDiproses> data) {
        if (data == null) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_status_perpanjangan_proses, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
       ...
       ModelStatusPerpanjanganDiproses item = data.get(position);
...
//selesai
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            idPerpanjanganView = itemView.findViewById(R.id.id_perpanjang_diproses);
            tglperpanjanganTextView = itemView.findViewById(R.id.tgl_perpanjang_diproses);
            id_seniman = itemView.findViewById(R.id.nama_perpanjang_diproses);
        }
    }
}
