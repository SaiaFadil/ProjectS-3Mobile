...
public class StatusSenimanDitolakAdapter extends RecyclerView.Adapter<StatusSenimanDitolakAdapter.ViewHolder> {

    private List<ModelStatusSenimanDitolak> data;

    public StatusSenimanDitolakAdapter(List<ModelStatusSenimanDitolak> data) {
        if (data == null) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_status_seniman_ditolak, parent, false);
...
//selesai ne
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            idSenimanTextView = itemView.findViewById(R.id.id_seniman_ditolak);
            tglSenimanTextView = itemView.findViewById(R.id.tgl_seniman_ditolak);
            namaSenimanTextView = itemView.findViewById(R.id.nama_seniman_ditolak);
        }
    }
}
